...
const UpazilaModel = require('../../models/GeoModel/upazilaModel')

exports.createUpazila = catchAsync(async (req, res, next) => {
    const upazila = await UpazilaModel.create(req.body);
    res.status(200).json({
        status: 'success',
        upazila
    })
